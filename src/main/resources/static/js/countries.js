...
var countries = ["Afghanistan","Albania","Algeria",
    ...
    "China","Colombia","Congo Brazzaville","Congo Democratique",
...
autocomplete(document.getElementById("text-country"), countries);
autocomplete(document.getElementById("text-province"), provinces);
autocomplete(document.getElementById("text-commune"), communes);
